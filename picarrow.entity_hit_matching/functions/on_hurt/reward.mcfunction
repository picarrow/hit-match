...
execute as @e[type=#picarrow.entity_hit_matching:targets] if score @s picarrow.ehm.id = #target_id picarrow.ehm.id at @s run function picarrow.entity_hit_matching:action/target_hits_player
