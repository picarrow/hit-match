...
execute as @e[type=#picarrow.entity_hit_matching:targets] if score @s picarrow.ehm.id = #id_of_struck_entity picarrow.ehm.id at @s run function picarrow.entity_hit_matching:action/target_is_hurt_by_player
