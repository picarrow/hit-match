...
# ...
execute unless score #_is_entity_loaded ehm._ matches 1 run function hit_match:_death_detect/tick/loop_poll/loop_entry_in_live_queue/_2 with storage hit_match:data _.func."death_detect.tick".temp
