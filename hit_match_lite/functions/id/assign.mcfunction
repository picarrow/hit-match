...
function hit_match_lite:id/clear_command_tags

# Assign an ID
execute if score #next_id ehm._ matches 19683.. run function hit_match_lite:id/reset_all
...
function hit_match_lite:id/assign_1
